...
with open("/sise/home/tommarz/parler-hate-speech/emnlp23/all_parler_users_posts_list.json", 'r') as f:
    users_posts = json.load(f)
...
with open('parler_user_Sentenses_proc.json', 'w') as f:
